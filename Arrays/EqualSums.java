...
public class EqualSums {
    public static void main(String[] args) {
        ...
        int[] numbers = Arrays.stream(scanner.nextLine()
                ...
                .toArray();
        int[] arrayWithTwoZero = new int[numbers.length + 2];

        for (int i = 1, j = 0; i <= numbers.length; i++, j++) {  //добавяне на две нули, по една отпред и отзад!
            arrayWithTwoZero[i] = numbers[j];
        }
